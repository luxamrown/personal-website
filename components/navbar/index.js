    ...
    <>
        <Navbar bg="white" expand="xl">
            <Container fluid>
                ...
                <Navbar.Collapse id="responsive-navbar-nav" className={isMobile?'':'d-flex justify-content-end'}>
                    <Nav className="m-5 text-center">
                        ...
                        <Nav.Link href="/portofolio" className="mx-4 nav-text"><h5>Portofolio</h5></Nav.Link>
                        <Nav.Link href="/blog" className="mx-4 nav-text"><h5>Blog</h5></Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>        
